...
import {
  Activity, BookOpen, Boxes, Braces, ChartNoAxesCombined, ExternalLink, FlaskConical, Gauge, Home, Route, Sparkles,
} from "lucide-react";
    ...
    <div className="shell">
      <aside className="sidebar">
        <div className="brand">
          ...
          <div><div className="brand-title">Foundry Optimization<br />Companion</div><div className="brand-subtitle">Portal-first walkthrough</div></div>
        </div>
        ...
        <div className="sidebar-note">
          ...
          <a className="nav-link" href="https://ai.azure.com" target="_blank" rel="noreferrer"><ExternalLink size={16} />Open Foundry portal</a>
          <Link className="nav-link" href="/telemetry"><Braces size={16} />Open control room</Link>
        </div>
      </aside>
      <main className="main">{children}<div className="footer-note">Companion workload and visualization surface · Microsoft Foundry is the primary demo experience</div></main>
    </div>
  );
}
